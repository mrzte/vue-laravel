<template>
    <div class="container-fluid">
        <div class="col-lg-12 mt-4">
            <h2 class="mb-4 text-bold">404 Upss Halaman Yang anda cari tidak ada</h2>
...
<g
   ...
   x="1214.267"
   y="402.823"
   transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 2398.7004 -103.4094)"
   fill="#915BBC"
   width="13"
   height="84.518"
   id="rect18" />
   ...
   x="1181.117"
   y="378.139"
   transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 1765.3322 1520.3489)"
   fill="#915BBC"
   width="32.847"
   height="32.847"
   id="rect26" />
...
<rect
   x="1271.867"
   y="132.551"
   transform="matrix(0.7071 0.7071 -0.7071 0.7071 477.967 -858.394)"
   fill="#FFFFFF"
   width="6.579"
   height="30.418"
   id="rect186" />
<rect
   x="1164.975"
   y="239.443"
   transform="matrix(0.7071 0.7071 -0.7071 0.7071 522.2432 -751.502)"
   fill="#FFFFFF"
   width="6.579"
   height="30.418"
   id="rect188" />
...
<rect
   x="1271.867"
   y="239.443"
   transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 2356.895 -466.9532)"
   fill="#FFFFFF"
   width="6.579"
   height="30.418"
   id="rect194" />
<rect
   x="1164.975"
   y="132.551"
   transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 2098.8347 -573.8454)"
   fill="#FFFFFF"
   width="6.579"
   height="30.418"
   id="rect196" />
